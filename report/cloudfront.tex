...
\begin{figure*}[h]
    \centering
    \includegraphics[width=7in]{images/retrievals_california.png}
    \caption[]{Retrieval times using S3 in California (s)}
    \label{fig:retrievals_california}
\end{figure*}
\begin{figure*}[h]
    \centering
    \includegraphics[width=7in]{images/retrievals_ireland.png}
    \caption[]{Retrieval times using S3 in Ireland (s)}
    \label{fig:retrievals_ireland}
\end{figure*}
\begin{figure*}[h]
    \centering
    \includegraphics[width=7in]{images/retrievals_tokyo.png}
    \caption[]{Retrieval times using S3 in Tokyo (s)}
    \label{fig:retrievals_tokyo}
\end{figure*}
\begin{figure*}[h]
    \centering
    \includegraphics[width=7in]{images/retrievals_ireland_subset.png}
    \caption[]{Retrieval times using S3 in Ireland (from California and Singapore only) (ms)}
    \label{fig:retrievals_ireland_subset}
\end{figure*}
\begin{figure*}[h]
    \centering
    \includegraphics[width=5in]{images/pings.png}
    \caption[]{Latency using California S3, Ireland S3 and Tokyo S3 (ms))}
    \label{fig:pings}
\end{figure*}
