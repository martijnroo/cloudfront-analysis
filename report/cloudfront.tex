...
Amazon Cloudfront is service that provides a content delivery network (CDN). CDN is a geographically wide network of computer nodes that makes it possible to distribute content to end users with low latency and high data transfer speeds. As of Novemeber 2014, Amazon Cloudfront has edge locations in all continents except Africa and Antarctica. Most of them reside in USA, Europe and Asia. \cite{cloudfront_product_details}
